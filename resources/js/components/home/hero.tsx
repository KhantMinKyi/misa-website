...
const Hero = () => {
    return (
        <div className=' bg-gray-50 dark:bg-gray-950 w-full flex flex-col justify-center items-center pt-10 pb-24 md:pt-20 md:py-30 text-center'>
            <span className='text-xl text-gray-400'>Mandalay Internatinal School of Acumen</span>
            <h2 className='mb-6 mt-2 text-6xl text-yellow-400 dark:text-yellow-300 font-bold '>Welcome To MISA</h2>
